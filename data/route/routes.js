...
let arr = [
  { rt: 'Vancouver:Calgary', length: 3, c1: 'gray' },
  ...
  { rt: 'Portland:Salt Lake City', length: 6, c1: 'blue' },
  ...
  { rt: 'Los Angeles:Phoenix', length: 3, c1: 'gray' },
  ...
  { rt: 'Helena:Salt Lake City', length: 3, c1: 'pink' },
  ...
  { rt: 'Las Vegas:Salt Lake City', length: 3, c1: 'orange' },
  ...
  { rt: 'Winnipeg:Duluth', length: 4, c1: 'black' },
  ...
  { rt: 'Omaha:Chicago', length: 4, c1: 'blue' },
  ...
  { rt: 'Oklahoma City:Dallas', length: 2, c1: 'gray', c2: 'gray' },
  ...
  { rt: 'El Paso:Dallas', length: 4, c1: 'red' },
  ...
  { rt: 'Santa Fe:Denver', length: 2, c1: 'gray' },
  ...
  { rt: 'New Orleans:Little Rock', length: 3, c1: 'green' },
  ...
  { rt: 'Saint Louis:Chicago', length: 2, c1: 'green', c2: 'white' },
  ...
  { rt: 'Sault St. Marie:Toronto', length: 2, c1: 'gray' },
  ...
  { rt: 'Nashville:Raleigh', length: 3, c1: 'black' },
  ...
  { rt: 'Atlanta:Raleigh', length: 2, c1: 'gray', c2: 'gray' },
  ...
  { rt: 'New York:Boston', length: 2, c1: 'yellow', c2: 'red' },
